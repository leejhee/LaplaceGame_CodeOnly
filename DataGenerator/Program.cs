...
namespace DataGenerator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // StringData 따로 파싱
            string stringDataFolderPath = "../../../DataGenerator/XLSXS/StringData";
            string[] stringDataExcelFiles = Directory.GetFiles(stringDataFolderPath, "*.xlsx");

            foreach (string file in stringDataExcelFiles)
            {
                Console.WriteLine("Generate StringData file: " + Path.GetFileName(file));
                StringDataParseExcel(file);
        ...
        public static void StringDataParseExcel(string file)
        {
            string excelName = Path.GetFileNameWithoutExtension(Path.GetFileName(file));
            string dataRegister = string.Empty;
            string dataParse = string.Empty;
            ...
            dataRegister = dataRegister.Replace("\n", "\n\t\t");
            dataParse = dataParse.Replace("\n", "\n\t\t\t\t\t");
            var dataManagerText = string.Format(DataFormat.dataStringDataFormat, excelName, dataRegister, dataParse);
